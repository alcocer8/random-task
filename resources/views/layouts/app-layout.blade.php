...
<body
    ...
    <header class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
        <nav
            class="mt-4 relative max-w-2xl w-full bg-white border border-gray-400 rounded-full mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
            ...
            <div id="hs-navbar-header-floating"
                ...
                <div
                    ...
                    <form action="{{route("logout.index")}}" method="GET">
                        @csrf
                        <input class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-transparent text-gray-500 hover:text-gray-800 focus:outline-hidden dark:text-neutral-400 dark:hover:text-neutral-200"
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-[1920px] lg:flex-row justify-center">
            @yield('contenido')
        </main>
    </div>
